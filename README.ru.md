...
- Поддержка истории диалогов Claude Code и Cursor IDE
- Автоматическое обнаружение доступных источников данных
- Единый интерфейс для просмотра диалогов из обоих инструментов
- Легкое переключение между источниками
