...
Кроссплатформенное настольное приложение для просмотра истории диалогов Claude Code, хранящейся в `~/.claude`.
...
Claude Code сохраняет историю диалогов в файлах JSONL в папке `~/.claude/projects/`. Эти файлы трудночитаемы и неудобны для поиска. Данное приложение предоставляет удобный интерфейс для просмотра диалогов, статистики использования и поиска старых обсуждений.
