 ...
 * Stores user-customized data about sessions and projects separately from Claude Code data.
 *
 * This is the canonical implementation. Legacy files (metadata.types.ts) are deprecated.
 * Location for user data: ~/.claude-history-viewer/user-data.json
 */
